...
int main() {
	...
	std::vector<float> y = { 2.1,4.2,6.1,8.1,10.3,12.2,14.4,16.1,18.2,20.3 };
	...
	std::vector<float> v = { var(x,N),cov(x,y,N),pearson(x,y,N),l.a,l.b,l.f(4),dev(p,l) };
	std::vector<float> e = { 8.25,16.63,0.999,2.015,0.113,8.176,0.176 };
